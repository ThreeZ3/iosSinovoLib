...
- (void)onDelGwSubLock :(NSDictionary *)pNSDictionary;

- (void)onGetUserAvatar :(id)object;        //http get 请求用户的头像数据
- (void)onGetDFUInfo :(id)object;         //http get 请求获取dfu升级包的信息
- (void)onGetLockType :(id)object;          //http get 请求获取锁型号的信息
- (void)onGetLockImage :(id)object;          //http get 请求获取锁型号 对应的图片
...
- (void) delGWsubLock :(NSString *)lockID;      //删除网关下的子设备，也就是锁，解除他们之间的绑定关系
- (void) getUserAvatar :(NSString *)url ;
- (void) getLockType ;
- (void) getDFUInfo :(BOOL)isRelease ;  
- (void) getLockImage :(NSString *)url :(NSString *)lockType;
