...
- (void) onPublishTimeOut :(NSString *)data;
...
@property (nonatomic) BOOL sendingByMqtt;
@property (nonatomic,strong) NSObject<MqttDelegate> *delegate;
@property (nonatomic,strong) NSMutableArray *mqttCmdList;               //mqtt 发送队列
...
//stop to send command via mqtt
-(void) stopMqttSendCmd ;
